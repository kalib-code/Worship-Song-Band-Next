    ...
    <>
      <footer className={`footer-footer ${props.rootClassName} `}>
        ...
        <div className="footer-container2">
          <span className="footer-text2">{props.title_text}</span>
          <span className="footer-text3">{props.news_letter}</span>
          <form className="footer-form">
            ...
            />
            <button className="footer-button button">{props.button}</button>
          </form>
        </div>
      </footer>
      <style jsx>
